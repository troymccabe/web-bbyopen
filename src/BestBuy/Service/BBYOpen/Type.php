...
/**
 * {@link \BestBuy\Service\BBYOpen\Type} represents a resource type to be targeted by an API call.
 * BBYOpen currently includes 2 types of information:
 * {@link https://bbyopen.com/documentation/stores-api stores} and
 * {@link https://bbyopen.com/documentation/products-api products}.
 *
 * {@link https://bbyopen.com/documentation/products-api/get-store-availability Store Availability} information
...
class Type
{
     ...
     *
     * @param string $format \BestBuy\Service\BBYOpen::FORMAT_XML or \BestBuy\Service\BBYOpen::FORMAT_JSON
     * @throws Type\Exception
     */
