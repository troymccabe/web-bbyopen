...
/**
 * BestBuy\Service\BBYOpen\Response represents a response to a
 * {@link https://bbyopen.com BBYOpen} API call.
 *
 * In addition to the $data property (accessible via $response->data or $response->getData()),
 * a BestBuy\Service\BBYOpen\Response provides the following HTTP metadata collected by
...
class Response
{
    ...
    /**
     * Response body (if any) returned by BBYOpen
     *
     * @var string
     */
    protected $data = '';
    ...
    /**
     * Creates a new \BestBuy\Service\BBYOpen\Response object.
     *
     * @param string $data Response body (if any) returned by BBYOpen
    ...
    /**
     * Returns the content body (if any) returned by BBYOpen.
     *
     * @return string
     */
